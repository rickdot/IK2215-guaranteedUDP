...
public class GUDPPacket {
    ...
    public static final short HEADER_SIZE = 8;		//GUDP header size 8 bytes -> 32 bits
    public static final Integer MAX_DATA_LEN = 1000;
    public static final Integer MAX_DATAGRAM_LEN = MAX_DATA_LEN + HEADER_SIZE;  
    public static final Integer MAX_WINDOW_SIZE = 3;		// window size = 3
    ...
    // GUDP DATA packet = [payload(DatagramPacket) + GUDP header]
    public static GUDPPacket encapsulate(DatagramPacket packet) throws IOException {
        ByteBuffer buffer = ByteBuffer.allocate(packet.getLength() + HEADER_SIZE);		// size of DatagramPacket + size of GUDP header
